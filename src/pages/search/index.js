...
import { useSearchParams } from "react-router-dom"; // useSearchParams allows you to access and interact with the query parameters (search parameters) of the current URL in your application. Query parameters are key-value pairs typically used to pass data or configuration information in the URL.
